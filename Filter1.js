...
export default function Filter() {
    ...
    useEffect(() => {
      //fetch
      fetch(`http://localhost:7878/zomato/restaurants/filter/:${currentPageno}`,requestOptions)
    ...
    const handleCuisineChanges=(event)=>{
                        ...
                        <div className="col-sm-3 col-md-3 col-lg-3">
                            <div className="filter-options">
                                ...
                                <div id="demo" className="collapse show">
                                    ...
                                    <div>
                                        <input type="checkbox" name="North Indian" onChange={(e)=>handleCuisineChanges(e)} />
                                        <span className="checkbox-items">North Indian</span>
                                    </div>
                                    <div>
                                        <input type="checkbox" name="South Indian" onChange={(e)=>handleCuisineChanges(e)} />
                                        <span className="checkbox-items">South Indian</span>
                                    </div>
                                    <div>
                                        <input type="checkbox" name="Chineese" onChange={(e)=>handleCuisineChanges(e)} />
                                        <span className="checkbox-items">Chineese</span>
                                    </div>
                                    <div>
                                        <input type="checkbox" name="Fast Food" onChange={(e)=>handleCuisineChanges(e)}/>
                                        <span className="checkbox-items">Fast Food</span>
                                    </div>
                                    <div>
                                        <input type="checkbox" name="Street Food" onChange={(e)=>handleCuisineChanges(e)}/>
                                ...
                                <div className="Item" >
                                        <div className="row pl-1">
                                            <div className="col-sm-4 col-md-4 col-lg-4">
                                                <img className="img" src={require('../Assets/dinner.png')} />
                                            </div>
                                        ...
                                        <div className="row padding-left">
                                            <div className="col-sm-12 col-md-12 col-lg-12">
                                                <div className="rest-address">CUISINES : {item.Cuisine.length && item.Cuisine}</div>
