...
export default class Wallpaper extends Component {
  ...
  constructor(){
    ...
    componentDidMount(){
        ...
        //call my api 
        fetch('https://zomato-heroku-app-1.herokuapp.com/zomato/locations',{method:'GET'})
    ...
    fetchRestaurants = (event)=>{
        fetch(`https://zomato-heroku-app-1.herokuapp.com/zomato/restaurants/${event.target.value}`,{method:'GET'})
        .then(response=>response.json())
